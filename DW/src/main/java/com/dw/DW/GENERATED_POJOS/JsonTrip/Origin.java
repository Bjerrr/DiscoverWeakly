...
public class Origin {
     ...
     * @param lat
     */
    public Origin(String name, String type, String id, String extId, Double lon, Double lat, Integer routeIdx, String prognosisType, String time, String date) {
        super();
        this.name = name;
        this.type = type;
        this.id = id;
    ...
    public Origin withExtId(String extId) {
        this.extId = extId;
        return this;
    }
    ...
    public Origin withLon(Double lon) {
        this.lon = lon;
        return this;
    }
    ...
    public Origin withLat(Double lat) {
        this.lat = lat;
        return this;
    }
    ...
    public Origin withRouteIdx(Integer routeIdx) {
        this.routeIdx = routeIdx;
        return this;
    }
    ...
    public Origin withPrognosisType(String prognosisType) {
        this.prognosisType = prognosisType;
        return this;
    }
