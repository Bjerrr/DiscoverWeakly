...
public class Destination {
     ...
     * @param lat
     */
    public Destination(String name, String type, String id, String extId, Double lon, Double lat, Integer routeIdx, String prognosisType, String time, String date) {
        super();
        this.name = name;
        this.type = type;
        this.id = id;
    ...
    public Destination withExtId(String extId) {
        this.extId = extId;
        return this;
    }
    ...
    public Destination withLon(Double lon) {
        this.lon = lon;
        return this;
    }
    ...
    public Destination withLat(Double lat) {
        this.lat = lat;
        return this;
    }
    ...
    public Destination withRouteIdx(Integer routeIdx) {
        this.routeIdx = routeIdx;
        return this;
    }
    ...
    public Destination withPrognosisType(String prognosisType) {
        this.prognosisType = prognosisType;
        return this;
    }
