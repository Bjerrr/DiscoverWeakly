...
public class Origin__1 {
     ...
     * @param lat
     */
    public Origin__1(String name, String type, String id, String extId, Double lon, Double lat, Integer routeIdx, String prognosisType, String time, String date) {
        super();
        this.name = name;
        this.type = type;
        this.id = id;
    ...
    public Origin__1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Origin__1 withExtId(String extId) {
        this.extId = extId;
        return this;
    }
    ...
    public Origin__1 withLon(Double lon) {
        this.lon = lon;
        return this;
    }
    ...
    public Origin__1 withLat(Double lat) {
        this.lat = lat;
        return this;
    }
    ...
    public Origin__1 withRouteIdx(Integer routeIdx) {
        this.routeIdx = routeIdx;
        return this;
    }
    ...
    public Origin__1 withPrognosisType(String prognosisType) {
        this.prognosisType = prognosisType;
        return this;
    }
    ...
    public Origin__1 withTime(String time) {
        this.time = time;
        return this;
    }
    ...
    public Origin__1 withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Origin__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Origin__1) == false) {
            return false;
        }
        Origin__1 rhs = ((Origin__1) other);
