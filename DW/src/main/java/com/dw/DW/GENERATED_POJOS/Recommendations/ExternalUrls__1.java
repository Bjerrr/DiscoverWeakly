...
public class ExternalUrls__1 {
    ...
    public ExternalUrls__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExternalUrls__1) == false) {
            return false;
        }
        ExternalUrls__1 rhs = ((ExternalUrls__1) other);
