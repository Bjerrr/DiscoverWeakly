...
public class Artist__1 {
    ...
    public Artist__1 withExternalUrls(ExternalUrls__2 externalUrls) {
        this.externalUrls = externalUrls;
        return this;
    }
    ...
    public Artist__1 withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public Artist__1 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Artist__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Artist__1 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Artist__1 withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public Artist__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
